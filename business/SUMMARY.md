...
Ubuntu Health Vault is an app that lets South African patients own and control their own medical records. Instead of a clinic keeping your file somewhere you can't see, **you hold the key**. Your records are yours.
...
| Who | What they get |
|---|---|
| **Patients** | Ownership of their records, control over who sees them |
| **Doctors** | Full patient history at point of care, no missing context |
| **Clinic admins** | Dashboard to manage check-ins, queues, and access requests |
| **Rural & low-income users** | Works on basic feature phones via SMS/USSD — no smartphone needed |
...
Patients use it for **free**. Clinics pay a monthly subscription:
...
No paying customers yet. We are looking for our first 3 pilot clinics.
...
| Security audit + production deployment | R50,000 |
